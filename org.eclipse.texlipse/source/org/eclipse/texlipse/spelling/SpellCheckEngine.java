...
import org.eclipse.texlipse.spelling.engine.ISpellDictionary;
import org.eclipse.texlipse.spelling.engine.LocaleSensitiveSpellDictionary;
import org.eclipse.texlipse.spelling.engine.PersistentSpellDictionary;
...
public class SpellCheckEngine implements ISpellCheckEngine, IPropertyChangeListener {
	...
	public static Enumeration<URL> getDictionaryLocations() throws IOException {
		final TexlipsePlugin plugin = TexlipsePlugin.getDefault();
		if (plugin != null)
	...
	private SpellCheckEngine() {
		...
		fGlobalDictionaries.add(new TexTagDictionary());
		...
		TexlipsePlugin.getDefault().getPreferenceStore().addPropertyChangeListener(this);
	...
	public synchronized final ISpellChecker getSpellChecker() throws IllegalStateException {
		...
		IPreferenceStore store = TexlipsePlugin.getDefault().getPreferenceStore();
	...
	public synchronized final void shutdown() {
		...
		TexlipsePlugin.getDefault().getPreferenceStore().removePropertyChangeListener(this);
