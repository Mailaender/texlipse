...
import org.eclipse.texlipse.spelling.engine.ISpellEvent;
 ...
 * </p>
 */
public class TexSpellingProblem extends SpellingProblem {
	 ...
	 */
	public TexSpellingProblem(ISpellEvent spellEvent, IDocument document) {
	...
	public String getMessage() {
		if (isSentenceStart() && isDictionaryMatch())
			return MessageFormat.format(TexUIMessages.Spelling_error_case_label,
					new String[] { fSpellEvent.getWord() });

		return MessageFormat.format(TexUIMessages.Spelling_error_label, new String[] { fSpellEvent.getWord() });
	}
