...
public class WordIgnoreProposal implements IJavaCompletionProposal {
	...
	public String getAdditionalProposalInfo() {
		return Messages.format(TexUIMessages.Spelling_ignore_info, new String[] { WordCorrectionProposal.getHtmlRepresentation(fWord)});
	}
	...
	public String getDisplayString() {
		return Messages.format(TexUIMessages.Spelling_ignore_label, new String[] { fWord });
	}
